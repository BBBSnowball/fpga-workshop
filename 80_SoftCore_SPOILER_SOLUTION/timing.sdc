...
set_output_delay -clock clk 5 [get_ports {sevenseg_segment[*] sevenseg_digit[*] leds[*]}]
set_input_delay -clock clk 5 [get_ports {uart_sin}]
set_output_delay -clock clk 5 [get_ports {uart_sout}]
